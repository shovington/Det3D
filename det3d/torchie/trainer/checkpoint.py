...
def load_state_dict(module, state_dict, strict=False, logger=None):
    ...
    for name, param in state_dict.items():
        if name == "bbox_head.tasks.0.conv_box.weight" or name == "bbox_head.tasks.0.conv_box.bias" or name == "bbox_head.tasks.0.conv_cls.weight" or name == "bbox_head.tasks.0.conv_cls.bias":
            continue
